    ...
    <div class="container">
        <div class="header-wrapper">
            <a href="./index.html" class="header__logo">
                <img width="300" height="92" src="./images/svg/logo-yanicode.svg" alt="yanicode">
            </a>
...
<main class="website-workarea">
    ...
    <section class="banner banner_before1" style="background-image: url('./images/banner_blog.jpg');">
    ...
    <section class="container">
        <div class="blog-list">
            <a href="./blog-details.html" class="blog">
                <div class="blog__img">
                    <img width="100%" height="100%" src="./images/test_blog-img1.jpg" alt="">
                </div>
                ...
                <div class="blog__img">
                    <img width="100%" height="100%" src="./images/test_blog-img2.jpg" alt="">
                </div>
                <div class="blog__desc">
                    <div class="blog__title">
                ...
                <div class="blog__img">
                    <img width="100%" height="100%" src="./images/test_blog-img3.jpg" alt="">
                </div>
                <div class="blog__desc">
                    <div class="blog__title">
                        Что такое продакш-студия и для чего она нужна?
                ...
                <div class="blog__img">
                    <img width="100%" height="100%" src="./images/test_blog-img4.jpg" alt="">
                </div>
                <div class="blog__desc">
                    <div class="blog__title">
                        Личный бренд и что такое продакш- студия
